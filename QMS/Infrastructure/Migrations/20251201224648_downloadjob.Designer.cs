...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251201224648_downloadjob")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Application.FieldWork.SendFieldWorkEmail.UserDTO", b =>
                {
            ...
            modelBuilder.Entity("Application.Queries.GetBuildingQualityStats.BuildingQualityStatsDTO", b =>
                {
                    ...
                    b.ToTable("BuildingQualityStatsDTO");
                });

            modelBuilder.Entity("Application.Queries.GetBuildingSummaryStats.BuildingSummaryStatsDTO", b =>
                {
                    b.Property<string>("Municipality")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("BuildingSummaryStatsDTO");
                });

            modelBuilder.Entity("Application.Queries.GetDwellingQualityStats.DwellingQualityStatsDTO", b =>
                {
                    b.Property<string>("Municipality")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("TotalDwellings")
                        .HasColumnType("int");

                    b.ToTable("DwellingQualityStatsDTO");
                });

            modelBuilder.Entity("Application.Queries.GetFieldworkProgressByMunicipality.FieldworkProgressByMunicipalityDTO", b =>
                {
                    b.Property<int>("ApprovedBuildings")
                        .HasColumnType("int");

                    b.Property<int>("FieldworkBuildings")
                        .HasColumnType("int");
                    ...
                    b.ToTable("FieldworkProgressByMunicipalityDTO");
                });
            ...
            modelBuilder.Entity("Domain.DownloadJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.FieldWork", b =>
                {
                    ...
                    b.Property<int>("CloseEmailTemplateId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FieldWorkName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("OpenEmailTemplateId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.FieldWorkProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Jobs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Statistics", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
